    ...
    with col_a:
        if not theme_summary.empty:
            ...
            fig_vol = px.bar(
                ...
                x="comment_count",
                y="theme_label",
                labels={"comment_count": "Comment Count", "theme_label": "Theme"},
                orientation="h",
    ...
    with col_b:
        if not theme_impact.empty:
            ...
            fig_gap = px.bar(
                ...
                x="theme_nps_gap",
                y="theme_label",
                labels={"theme_nps_gap": "NPS Gap", "theme_label": "Theme"},
                orientation="h",
                color="theme_nps_gap",
    ...
    with col_c:
        if not store_scores.empty:
            ...
            fig_stores = px.bar(
                ...
                x="opportunity_score",
                y="store_name",
                labels={"opportunity_score": "Opportunity Score", "store_name": "Store Name"},
                orientation="h",
                color="region",
